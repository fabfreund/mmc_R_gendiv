...
set.seed(seeds1[20+4]) #Seed 20+i for mig scenario i (as in the filename)
#' Argument list
nsamp <- 100
...
popstruct <- list(c(5,95),c(25,75),c(45,55))
...
nsim <- 29000 #174K sims

#' Number of clusters
mc1 <- 16

#' resulting name
simname <- "sim_m8_mix2.RData"
